<?php
// source: C:\wamp64\www\IIS_PROJEKT\app\presenters\Administrace/templates/@layout.latte

class Template4cd1d832dcb1982203e39240e7ba1fe6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('553c046201', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbf36e721926_title')) { function _lbf36e721926_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
