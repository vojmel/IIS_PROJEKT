<?php
// source: C:\wamp64\www\IIS_PROJEKT\vendor\mesour\datagrid\src\Extensions/templates/Filter/NumberDropdown.latte

class Templatefb6f29b67b59ca2310607163c1e9884d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4e9cdd1add', 'html')
;
