<?php
// source: N:\programy\wamp64\www\projectIIS\IIS_PROJEKT\vendor\mesour\datagrid\src\Extensions/templates/Pager/Pager.latte

class Template82a3ad23139b3d921a1c171a4ffcd3f1 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2643890478', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block _pager
//
if (!function_exists($_b->blocks['_pager'][] = '_lbc1a226a169__pager')) { function _lbc1a226a169__pager($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('pager', FALSE)
