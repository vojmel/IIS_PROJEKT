<?php
// source: C:\wamp64\www\IIS_PROJEKT\vendor\mesour\datagrid\src\Grid/Grid.latte

class Template2661343d3620c26da349e2fd70325dbc extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('dfb50d4b9a', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block _dataGrid
//
if (!function_exists($_b->blocks['_dataGrid'][] = '_lb1a0d4e2cc4__dataGrid')) { function _lb1a0d4e2cc4__dataGrid($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('dataGrid', FALSE)
