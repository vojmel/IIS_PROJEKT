...
class Container_b822f7c65d extends Nette\DI\Container
{
	...
	{
		$service = new Nette\Database\Connection('mysql:dbname=xmeluz04;host=localhost;mysql_socket=/var/run/mysql/mysql.sock',
			'xmeluz04', 'vum4ajtu', NULL);
	...
	{
		return new Container_b822f7c65d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_b822f7c65d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_b822f7c65d $container)
	{
