<?php
// source: C:\wamp64\www\IIS_PROJEKT\app/config.neon 

class Container_e4b9a4ba3c extends Nette\DI\Container
{
		...
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'security.user',
					'session.session',
					'26_App_Model_AlbumRepository',
					'27_App_Model_Authenticator',
					'application.1',
					'application.2',
					'container',
				),
			...
			'App\Model\AlbumRepository' => array(
				1 => array('26_App_Model_AlbumRepository'),
			),
			'Nette\Security\IAuthenticator' => array(
				1 => array('27_App_Model_Authenticator'),
			),
			'App\Model\Authenticator' => array(
				1 => array('27_App_Model_Authenticator'),
			),
			...
			'App\Presenters\DashboardPresenter' => array(array('application.1')),
			'App\Presenters\SignPresenter' => array(array('application.2')),
			'Nette\DI\Container' => array(1 => array('container')),
		),
		'services' => array(
			'26_App_Model_AlbumRepository' => 'App\Model\AlbumRepository',
			'27_App_Model_Authenticator' => 'App\Model\Authenticator',
			'application.1' => 'App\Presenters\DashboardPresenter',
	 ...
	 */
	public function createService__26_App_Model_AlbumRepository()
	{
	 ...
	 */
	public function createService__27_App_Model_Authenticator()
	{
	...
	{
		$service = new App\Presenters\DashboardPresenter($this->getService('26_App_Model_AlbumRepository'));
	...
	{
		$service = new Nette\Database\Connection('sqlite:C:\wamp64\www\IIS_PROJEKT\app/model/demo.db3', NULL, NULL, NULL);
	...
	{
		return new Container_e4b9a4ba3c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_e4b9a4ba3c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_e4b9a4ba3c $container)
	{
