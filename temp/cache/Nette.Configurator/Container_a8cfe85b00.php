<?php
// source: C:\wamp64\www\nette\examples\CD-collection\app/config.neon 

class Container_a8cfe85b00 extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			...
			'wwwDir' => 'C:\wamp64\www\nette\examples\CD-collection\www',
			'debugMode' => TRUE,
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\wamp64\www\nette\examples\CD-collection\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\wamp64\www\nette\examples\CD-collection\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('sqlite:C:\wamp64\www\nette\examples\CD-collection\app/model/demo.db3', NULL,
			NULL, NULL);
	...
	{
		return new Container_a8cfe85b00_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\wamp64\www\nette\examples\CD-collection\app/../temp/cache/latte');
...
final class Container_a8cfe85b00_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_a8cfe85b00 $container)
	{
